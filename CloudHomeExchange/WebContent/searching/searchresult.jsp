	...
	<div class="border_box">
		...
		<div class="main_box">
			...
			<div class="mainresult">
				<div class="btn_back">
					<button><a href="../searching/searchhouse.html">back</a></button>
				</div>
				<div class="result">
							...
							<div class="house_info">
								...
								<div class="house_contact">
									<div class="house_contact_loc">
										<i class="fas fa-search-location">  address</i>
									</div>
									<br>
									<br>
					...
					<div class="result_rooms">
						<div class="rooms">
							<i class="fas fa-bed">  3 Bedrooms</i>
						</div>
						<div class="rooms">
							<i class="fas fa-users">  6 Sleeps</i>
						</div>
						<div class="rooms">
							<i class="fas fa-bath">  1 Bathroom</i>
						</div>
					</div>
